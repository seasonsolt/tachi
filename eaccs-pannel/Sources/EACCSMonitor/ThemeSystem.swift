...
// MARK: - Theme Names matching ritual-screen/packages/shared/src/constants.ts

enum RitualThemeName: String, CaseIterable, Codable {
...
struct RitualThemeColors {
    ...
    static func forTheme(_ theme: RitualThemeName) -> RitualThemeColors {
        switch theme {
        case .cyber:
